...
<section id="cabecera-art">
	<div class="container">
		<div class="flex_column av_three_fourth first main_color">
                        <div class="post-img">
...
<section id="msj-tw">
	<div class="container">
		<div class="flex_column av_two_fifth first el_after_av_section el_before_av_three_fifth avia-builder-el-first">
                        <div class="tw-img">
			   <img src="<?php echo get_home_url(); ?>/wp-content/themes/curul501/images/12.png">
                        </div>
		</div>
