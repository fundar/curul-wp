				...
				<main class="content units av-content-small alpha cpt-iniciativa" role="main">
					...
					<div class="entry-content no-voto" itemprop="text">
						<ul class="lista-iniciativas">
							...
							<?php if($presentada_partido != "") { ?> <a href="<?php echo get_site_url() . '/iniciativas/?partido-politico=' . $partido_politico_slug; ?>"> <?php echo  $presentada_partido."</br>";} ?>
							<?php if($presentada_representante != "") { ?> <a href="http://www.curul501.org/representantes/<?php echo $presentada_representante_slug ?>"> <?php echo  str_replace('|', " ", $presentada_repres							
