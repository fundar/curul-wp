				...
				<main class="content units av-content-small alpha cpt-iniciativa" role="main">
					...
					<div class="entry-content no-voto" itemprop="text">
						<ul class="lista-iniciativas">
							...
							<p> <?php   if($id==1295) { echo "Partido Revolucionario Institucional, Partido Acción Nacional,Partido de la Revolución Democrática"; }  else { ?> <?php if($presentada_dependencia != "") { echo $presentada_dependencia."</br></br>";} ?>
