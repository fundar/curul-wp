...
<?php if($id_tipo==1) { ?>  <span id="general"> LAS 8<small><b>+</b>1</small> </span> <br>Conoce los temas más preocupantes<br> de la nueva Ley General de Transparencia</h2><?php  }  else { ?> <span id="general"> Ley General </span> <br>de deaparación forzada</h2>     <?php } ?>
