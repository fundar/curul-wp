											...
											<div class="flex_column av_two_third first avia-builder-el-0 el_before_av_one_third avia-builder-el-first topTop">
												...
												<div class="entry-content no-voto">
													 <p class="resemen-recientes-iniciativas titulo-<?php the_ID(); ?>">
												         ...
												         </p><div class="enCamara_Iniciativas"><span>En la C&aacute;mara de: Diputados</span></div><p>En la cámara de: Diputados</p>
													 <?php the_excerpt(); ?> 
										...
										<div class="entry-content-wrapper clearfix">
											...
											<div class="flex_column av_two_third first avia-builder-el-0 el_before_av_one_third avia-builder-el-first topTop">
												...
												<div class="entry-content">
													 ...
													 <div class="enCamara_Iniciativas"><span>En la C&aacute;mara de: Diputados</span></div>
													 <?php the_excerpt(); ?> 
